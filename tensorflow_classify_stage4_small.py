...
if(stamp4=='NA'):
    ...
    weight4 = {
        'conv':   tf.Variable(tf.truncated_normal([fs_4a,fs_4a,nf_encode3,nf_conv4],stddev=0.1)),
        'encode': tf.Variable(tf.truncated_normal([fs_4b,fs_4b,nf_conv4,nf_encode4],stddev=0.1)),
    }
    bias4 = {
    ...
    file_w4 = 'weight4b.{}.pkl'.format(stamp4)
    file_b4 = 'bias4b.{}.pkl'.format(stamp4)
...
def get_encode4(qqq):
    qqq1 = tf.nn.conv2d(qqq, weight4['conv'], strides=[1, fs_4a, fs_4a, 1], padding='VALID')
...
def save_stage4():
    ...
    myutil.saveObject(weight4_fin,'weight4b.{}.pkl'.format(stamp))
    myutil.saveObject(bias4_fin,'bias4b.{}.pkl'.format(stamp))
